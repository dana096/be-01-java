package day18.jdbc.mvc.controller;
...
import day18.jdbc.mvc.connUtil.CloseHelper;
import day18.jdbc.mvc.connUtil.ConnectionHelper;
import day18.jdbc.mvc.model.GiftDTO;
...
public class GiftController {  // Controller 
	...
	public static void selectAll(String className) throws SQLException {
		...
		int count = rsmd.getColumnCount();  // 4 (db 테이블의 필드 갯수)
