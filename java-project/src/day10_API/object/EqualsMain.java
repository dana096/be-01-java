...
public class EqualsMain {
	public static void main(String[] args) {
		...
		else System.out.println("not same");  // 두 코드는 주소가 다르기 때문에 같지 않다
		
		System.out.println("***** equals method *****");  // equals() : 대소문자 구분하고 비교
		if ( s1.equals(s2) ) System.out.println("same!!!");
		else System.out.println("not same!!!");
		
		System.out.println("***** equalsIgnoreCase method *****");  // equalsIgnoreCase() : 대소문자 구분 안하고 비교
